    ...
    if(archivo.is_open() && temp.is_open())
    {
        while (archivo >> e.nombre >> e.carnet >> e.edad)
        {
            if (e.carnet == buscado)
            {
                ...
                cout << "Reemplaza el nombre del estudiante: "<<endl;
                cin >> e.nombre;

                cout << "Reemplaza el carnet del estudiante"<<endl;
                cin >> e.carnet;

                cout << "Reemplaza la edad del estudiante"<<endl;
                cin >> e.edad;
            ...
            {
                cout << "No se encontro el carnet del estudiante"<<endl;
            }
